...
public abstract class List<A> {
  ...
  private <B> TailCall<B> foldRight_(List<A> list, B accum, Function<A, Function<B, B>> f) {
    return list.isEmpty() ? ret(accum) : sus(() -> foldRight_(list.tail(), f.apply(list.head()).apply(accum), f));
  }
